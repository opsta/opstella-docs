...
1. การพิสูจน์แนวคิด (Proof of Concept) สำหรับ Opstella และแพลตฟอร์ม DevSecOps ทั้งระบบ
2. Environment สำหรับการทดสอบหรือ staging

#### Specification

สเปกของ virtual machine ที่ต้องสร้าง มีรายละเอียดดังนี้
...
คุณต้องเตรียมโดเมนไว้ ในตัวอย่างสถาปัตยกรรมอ้างอิงนี้เราจะใช้ ***.devops.example.com** พร้อมใบรับรอง SSL โดยเป็นโดเมนที่จะกำหนดให้กับเครื่องมือ DevSecOps และ Opstella
...
การ deploy ที่ขยายขนาดได้สำหรับ Environment แบบ production
