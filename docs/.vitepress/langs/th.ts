...
function nav(): DefaultTheme.NavItem[] {
  return [
    {
      text: "Introduction",
      link: `/${LANG_PREFIX}` + "/intro/what-is-opstella",
      ...
      items: [
        {
          ...
          items: [
            ...
            { text: "CI/CD & Automated Testing", link: "/cicd-automated-testing" },
            { text: "Identity & Access", link: "/identity-and-access" },
            { text: "Object Storage", link: "/object-storage" },
            { text: "Managed File Transfer", link: "/managed-file-transfer" },
          ],
        },
      ],
    },
