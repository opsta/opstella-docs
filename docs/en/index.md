...
features:
  - title: Introduction
    icon:
      src: /images/heroes/index-opstella.svg
      width: 50
      height: 50
  ...
  - title: Role and Permissions
    icon:
      src: /images/heroes/index-role.svg
      width: 40
      height: 40
  ...
  - title: Deploy Application
    icon:
      src: /images/heroes/index-deploy.svg
      width: 40
      height: 40
  ...
  - title: Usecases
    icon:
      src: /images/heroes/index-usecase.svg
      width: 40
      height: 40
  ...
  - title: Troubleshoot
    icon:
      src: /images/heroes/index-tbs.svg
      width: 40
      height: 40
